...
export default {
  ...
  computed: {
    width() {
      // 最后那个星的百分数
      let width =
        Number(this.childScore * 100 - Math.floor(this.childScore) * 100) + "%"; // 去设置半颗星的宽度
      return width;
    }
  },
  mounted() {},
...
<style scoped>
@import url("../../assets/iconfont/rater/iconfont.css");
/* @r: 100; */
.icon-xingxingshixin {
  font-size: 62rem / 100;
  position: relative;
